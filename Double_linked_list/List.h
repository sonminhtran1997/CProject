...
//		modified by Paul Bladek and An Dien Tang
//	Date: original: Summer 1996
//			5/15/2015
//	Version: 1.5
//	Environment: 	ntel Xeon PC
...
//				datatype pop_front(); -- removes front element 
//					and returns the data from that element
//				void push_back(datatype datum) -- insert element at back of list 
//				datatype pop_back() -- removes back element
//					and returns the data from that element
...
//			May 10, 2015, AT completed version 1.15
//---------------------------------------------------------------------------------------------------------------------------
namespace AT_ADT
{
	...
	public:
		...
		virtual void push_front(datatype datum); 
		virtual datatype pop_front(); 
		virtual void push_back(datatype datum); 
